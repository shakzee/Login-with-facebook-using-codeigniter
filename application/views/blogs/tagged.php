...
<div class="container">
  <div class="row">
    <div class="com-md-12">
      <h1><strong class="stblog"> <?php if(!empty($tagname)) echo ucwords($tagname);?></strong></h1>
        <ul class="breadcrumb">
          <li>
      ...
      <div class="col-right">
          <?php if($sort_blog): ?>
            ...
            <div class="post">
                  ...
                  <a href="<?php echo base_url('blogs/readblog/'.$blog->b_id.'/'.word_limiter(url_title($blog->blog_title,'dash', true),20,'...')) ?>">
                    <img src="<?php echo base_url('assets/images/blogs/'.$blog->blog_cover) ?>" alt="<?php echo word_limiter($blog->blog_title,10,'...') ?>" class="img-responsive">
                  </a>
